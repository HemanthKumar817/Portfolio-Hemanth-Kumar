...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    const getOffsets = (evt: MouseEvent | Touch, el: HTMLElement) => {
    ...
    useEffect(() => {
        ...
        const pointerMoveHandler = (e: Event) => handlePointerMove(e as unknown as PointerEvent);
        const pointerEnterHandler = (e: Event) => handlePointerEnter(e as unknown as PointerEvent);
